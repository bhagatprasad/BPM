...
(
    ...
    distributorcode character varying(50) COLLATE pg_catalog."default" NOT NULL,
    distributorname character varying(200) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT uq_distributors_code UNIQUE (distributorcode)
) 